        ...
        >
          ...
          <div className="flex mb-6 border border-border overflow-hidden">
            <button
              ...
              style={mode === "login" ? { borderBottom: "2px solid white" } : {}}
            ...
            <button
              ...
              style={mode === "register" ? { borderBottom: "2px solid white" } : {}}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 font-display text-xs uppercase tracking-widest font-bold transition-all duration-200 mt-2 bg-primary text-white hover:brightness-110 active:scale-98 disabled:opacity-50 disabled:cursor-not-allowed"
