...
- НЕ выдавай полный отчёт заново: без JSON, без заголовков и простыней списков. Живой ответ 3-6 предложений.
- Вопрос в конце — ТОЛЬКО когда он действительно уместен по контексту. Не заканчивай вопросом каждый ответ: иногда достаточно твёрдого совета, вывода или спокойной поддержки. Разнообразь форму ответов.
