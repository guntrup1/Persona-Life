...
const tradingSystemSchema = z.object({
  ...
  holdFrom: z.string().optional(),
  holdTo: z.string().optional(),
  breakevenRules: z.string().optional(),
  skipDayRules: z.string().optional(),
    ...
    try {
      ...
      await TradingSystem.findOneAndUpdate(
        { userId: req.session.userId, systemId: data.systemId },
        {
          ...
          holdFrom: data.holdFrom || "",
          holdTo: data.holdTo || "",
          breakevenRules: data.breakevenRules || "",
          skipDayRules: data.skipDayRules || "",
