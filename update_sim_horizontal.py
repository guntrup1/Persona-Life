              ...
              <div className="w-[40%] flex flex-col justify-between h-full">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md space-y-5">
                  <div className="flex justify-between items-center border-b border-white/10 pb-5">
                    <div>
                      <p className="text-xs text-zinc-500 uppercase tracking-widest mb-1 font-semibold">Винрейт</p>
                      <p className="text-3xl font-black text-white">{viewingSim.winRate}%</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs text-zinc-500 uppercase tracking-widest mb-1 font-semibold">Risk : Reward</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <div>
                       <p className="text-[10px] text-zinc-500 uppercase tracking-widest mb-1 font-semibold">Период бэктеста</p>
                       <p className="text-lg font-bold text-white">{viewingSim.backtestDays || "?"} дней</p>
                     </div>
                     <div>
                       <p className="text-[10px] text-zinc-500 uppercase tracking-widest mb-1 font-semibold">Всего сделок</p>
                       <p className="text-lg font-bold text-white">{viewingSim.trades}</p>
                     </div>
                     <div className="col-span-2 pt-2 border-t border-white/5">
                       <p className="text-[10px] text-zinc-500 uppercase tracking-widest mb-1 font-semibold">Риск на сделку</p>
                       <p className="text-lg font-bold text-red-400">{viewingSim.riskPercent}% <span className="text-zinc-600 text-xs">({viewingSim.riskType})</span></p>
                     </div>
                  </div>
                </div>
              ...
              <div className="w-[60%] flex flex-col justify-between h-full">
                ...
                {viewingSim.mode === "PROP" ? (
                  ...
                  <div className="bg-gradient-to-br from-yellow-900/20 to-zinc-900/30 border border-yellow-500/20 rounded-3xl p-8 shadow-[0_0_40px_rgba(234,179,8,0.1)] flex-grow flex flex-col justify-center">
                    <h3 className="text-center text-yellow-500/50 text-sm uppercase tracking-[0.2em] font-black mb-12">Итог стратегии (Self)</h3>
                    
                    <div className="flex justify-center items-center w-full">
                      <div className="flex-1 text-center border-r border-white/10 pr-8">
                        <p className="text-zinc-400 text-sm uppercase tracking-widest mb-4 font-medium">Мат. Ожидание (EV)</p>
                ...
                <div className="bg-white/5 border border-white/10 rounded-3xl p-6 mt-6 h-[180px] flex flex-col justify-between backdrop-blur-md">
                   <div className="flex justify-between items-center mb-2 px-2">
                     <span className="text-zinc-500 text-xs font-semibold uppercase tracking-widest">График симуляции (Медиана)</span>
